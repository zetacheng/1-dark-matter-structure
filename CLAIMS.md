...
| P1-CL-007 | Three-model comparison with μ/D/i nuisances and a global intrinsic scatter: RAR single-`a0` `dAIC` 0; Yukawa +4859; NFW −1614. Fitted `f_int`: 0.050 / 0.156 / 0.034. | SUPPORTED | Paper v16.3 Sec.~9 (`sec:refit`) + abstract. **Provenance gap:** producing script `intrinsic_scatter_comparison.py` is NOT in the imported record; reviewer-reproduced elsewhere. The present error-floor analog (`P1-NUISANCE-01`) gives Yukawa +9660 / NFW −2092 at floor 6 — a *different* likelihood. See `results/intrinsic-scatter/PROVENANCE.md`. | P1-ISCATTER-01 | Sec.~9 Single-`a0` refit (`sec:refit`) | 2026-07-16 |
